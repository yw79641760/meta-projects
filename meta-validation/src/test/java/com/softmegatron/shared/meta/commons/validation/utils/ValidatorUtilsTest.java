package com.softmegatron.shared.meta.commons.validation.utils;
...
public class ValidatorUtilsTest {
    ...
    public void testValidateWithNullName() {
        ...
        } catch (com.softmegatron.shared.meta.commons.validation.exception.ViolationException e) {
    ...
    public void testTryValidateRegexWithNonMatchingValue() {
        try {
            ...
            assertNotNull("异常不应该为null", e);
            Set<com.softmegatron.shared.meta.commons.validation.model.Violation> violations = e.getViolations();
            assertNotNull("violations不应该为null", violations);
            assertTrue("violations应该有1个元素", violations.size() == 1);
            
            com.softmegatron.shared.meta.commons.validation.model.Violation violation = 
