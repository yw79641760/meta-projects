package com.softmegatron.shared.meta.commons.remoting.http;

import com.softmegatron.shared.meta.commons.remoting.core.RemoteService;
import com.softmegatron.shared.meta.commons.remoting.http.model.HttpRemoteInvocation;
import com.softmegatron.shared.meta.commons.remoting.http.model.HttpRemoteResponse;
import com.softmegatron.shared.meta.commons.remoting.http.utils.EasyX509TrustManager;
import com.softmegatron.shared.meta.commons.remoting.http.utils.HttpRemoteUtils;
...
import static com.softmegatron.shared.meta.commons.remoting.http.constants.HttpRemoteConstants.CONN_FAILURE_RETRY;
import static com.softmegatron.shared.meta.commons.remoting.http.constants.HttpRemoteConstants.DEFAULT_CONN_TIMEOUT;
import static com.softmegatron.shared.meta.commons.remoting.http.constants.HttpRemoteConstants.DEFAULT_READ_TIMEOUT;
import static com.softmegatron.shared.meta.commons.remoting.http.constants.HttpRemoteConstants.DEFAULT_WRITE_TIMEOUT;
import static com.softmegatron.shared.meta.commons.remoting.http.utils.HttpRemoteUtils.createEasySSLContext;
