package com.softmegatron.meta.remoting.http;

import com.softmegatron.meta.remoting.common.RemoteService;
import com.softmegatron.meta.remoting.http.model.HttpRemoteInvocation;
import com.softmegatron.meta.remoting.http.model.HttpRemoteResponse;
import com.softmegatron.meta.remoting.http.utils.EasyX509TrustManager;
import com.softmegatron.meta.remoting.http.utils.HttpRemoteUtils;
...
import static com.softmegatron.meta.remoting.http.constants.HttpRemoteConstants.CONN_FAILURE_RETRY;
import static com.softmegatron.meta.remoting.http.constants.HttpRemoteConstants.DEFAULT_CONN_TIMEOUT;
import static com.softmegatron.meta.remoting.http.constants.HttpRemoteConstants.DEFAULT_READ_TIMEOUT;
import static com.softmegatron.meta.remoting.http.constants.HttpRemoteConstants.DEFAULT_WRITE_TIMEOUT;
import static com.softmegatron.meta.remoting.http.utils.HttpRemoteUtils.createEasySSLContext;
