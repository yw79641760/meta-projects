package com.megatron.shared.meta.remoting.http;

import com.megatron.shared.meta.remoting.common.RemoteService;
import com.megatron.shared.meta.remoting.http.model.HttpRemoteInvocation;
import com.megatron.shared.meta.remoting.http.model.HttpRemoteResponse;
import com.megatron.shared.meta.remoting.http.utils.EasyX509TrustManager;
import com.megatron.shared.meta.remoting.http.utils.HttpRemoteUtils;
...
import static com.megatron.shared.meta.remoting.http.constants.HttpRemoteConstants.CONN_FAILURE_RETRY;
import static com.megatron.shared.meta.remoting.http.constants.HttpRemoteConstants.DEFAULT_CONN_TIMEOUT;
import static com.megatron.shared.meta.remoting.http.constants.HttpRemoteConstants.DEFAULT_READ_TIMEOUT;
import static com.megatron.shared.meta.remoting.http.constants.HttpRemoteConstants.DEFAULT_WRITE_TIMEOUT;
import static com.megatron.shared.meta.remoting.http.utils.HttpRemoteUtils.createEasySSLContext;
