package com.softmegatron.shared.meta.data.utils;

import com.softmegatron.shared.meta.data.base.ListResponse;
import com.softmegatron.shared.meta.data.base.PageData;
import com.softmegatron.shared.meta.data.base.PageInfo;
import com.softmegatron.shared.meta.data.base.PageRequest;
import com.softmegatron.shared.meta.data.base.PageResponse;
...
public class ResponseUtils {
     ...
     * @return
     */
    public static <T, R> List<R> convertList(List<T> listInfo, Function<T, R> mapper) {
     ...
     * @return
     */
    public static <T, R> List<R> convertList(List<T> listInfo,
                                             Predicate<T> preFilter,
                                             Function<T, R> mapper,
                                             Predicate<R> postFilter) {
        return listInfo.stream().filter(preFilter).map(mapper).filter(postFilter).toList();
    }
     ...
     * @return
     */
    public static <T, R> ListResponse<R> toListResponse(List<T> listInfo, Function<T, R> mapper) {
     ...
     * @return
     */
    public static <T, R> ListResponse<R> toListResponse(List<T> listInfo,
                                                        Predicate<T> preFilter,
                                                        Function<T, R> mapper,
                                                        Predicate<R> postFilter) {
        return new ListResponse.Builder<R>().success()
     ...
     * @return
     */
    public static <T, R> PageResponse<R> toPageResponse(List<T> listInfo,
                                                        Function<T, R> mapper,
                                                        PageInfo pageInfo) {
