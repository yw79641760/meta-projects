package com.softmegatron.shared.meta.commons.data.model.algo.graph;
...
public abstract class BaseMutableGraph<Vertex, VertexInfo, Edge, EdgeInfo>
    ...
    protected BaseMutableGraph() {
        super();
    }

    protected BaseMutableGraph(Map<Vertex, VertexInfo> vertexMap,
