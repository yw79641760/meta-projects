package com.softmegatron.shared.meta.serial.lang;
...
public class CommonsLangSerializerDemo {
    ...
    private static void demonstrateSpiIntegration() {
        ...
        java.util.ServiceLoader<com.softmegatron.shared.meta.serial.spi.ObjectSerializer> loader = 
            java.util.ServiceLoader.load(com.softmegatron.shared.meta.serial.spi.ObjectSerializer.class);
        
        for (com.softmegatron.shared.meta.serial.spi.ObjectSerializer serializer : loader) {
