package com.softmegatron.shared.meta.extension.factory;
...
public class ExtensionFactoryTest {
    ...
    public void testExtensionFactoryHasSPIAnnotation() {
        assertNotNull("ExtensionFactory应该有SPI注解", 
                     ExtensionFactory.class.getAnnotation(com.softmegatron.shared.meta.extension.annotation.SPI.class));
    }

    @Test
    public void testSPIAnnotationValue() {
        com.softmegatron.shared.meta.extension.annotation.SPI annotation = 
            ExtensionFactory.class.getAnnotation(com.softmegatron.shared.meta.extension.annotation.SPI.class);
